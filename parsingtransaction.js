...
export function parseTransactionData(buffer) {
  try {
    ...
    if (buffer.length == 401) {
      ...
      let isBuy =true;
      let pool_status = "pumpswap";
      let solchange = parsedData_PumpSwap.userQuoteAmountIn;
      let tokenchange = parsedData_PumpSwap.baseAmountOut;
      if (parsedData_PumpSwap.coinCreator == "11111111111111111111111111111111") {
        isBuy =false;
        pool_status = "pumpswap_direct";
        solchange = parsedData_PumpSwap.baseAmountOut;
        tokenchange = parsedData_PumpSwap.userQuoteAmountIn;
      }
      
        return {
          solchange: solchange, // the amount of sol/quote user put in
          tokenchange: tokenchange,   // the amount of token/base received
          isBuy,
      ...
      // console.log("🎈🎈🎈parsedData_PumpFun:::", parsedData_PumpFun);
